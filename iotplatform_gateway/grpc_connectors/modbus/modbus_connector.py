...
from iotplatform_gateway.connectors.modbus.constants import TAG_PARAMETER, BYTE_ORDER_PARAMETER, WORD_ORDER_PARAMETER, \
    TYPE_PARAMETER, ADDRESS_PARAMETER, OBJECTS_COUNT_PARAMETER, PAYLOAD_PARAMETER, RPC_SECTION, UNIT_ID_PARAMETER, \
    LAST_PREFIX
from iotplatform_gateway.gateway.constants import DEVICE_NAME_PARAMETER, DEVICE_SECTION_PARAMETER, DATA_PARAMETER, \
...
from iotplatform_gateway.grpc_connectors.gw_grpc_connector import GwGrpcConnector, log
from iotplatform_gateway.grpc_connectors.gw_grpc_msg_creator import GrpcMsgCreator
from iotplatform_gateway.grpc_connectors.modbus.slave import Slave
from iotplatform_gateway.tb_utility.tb_utility import TBUtility
from iotplatform_gateway.connectors.modbus.modbus_connector import FUNCTION_CODE_WRITE, FUNCTION_TYPE, \
