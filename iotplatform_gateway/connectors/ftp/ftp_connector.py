...
from iotplatform_gateway.connectors.ftp.file import File
from iotplatform_gateway.connectors.ftp.ftp_uplink_converter import FTPUplinkConverter
from iotplatform_gateway.connectors.ftp.path import Path
...
class FTPConnector(Connector, Thread):
    ...
    def __send_data(self, converted_data: ConvertedData):
        if (converted_data and
            ...
            self.__log.debug("Data being sent to IOTPlatform: %s", converted_data)
