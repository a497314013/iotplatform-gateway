...
from iotplatform_gateway.connectors.xmpp.device import Device
from iotplatform_gateway.gateway.entities.converted_data import ConvertedData
from iotplatform_gateway.gateway.statistics.decorators import CollectStatistics, CollectAllReceivedBytesStatistics
        ...
        while not self.__stopped:
            if not XMPPConnector.DATA_TO_SEND.empty():
                ...
                if data.attributes_datapoints_count > 0 or data.telemetry_datapoints_count > 0:
                    ...
                    self.__log.info('Data to IOTPlatform %s', data)
