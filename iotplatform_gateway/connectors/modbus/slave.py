...
from iotplatform_gateway.connectors.modbus.modbus_converter import ModbusConverter
...
if TYPE_CHECKING:
    from iotplatform_gateway.connectors.modbus.modbus_connector import ModbusConnector
    from iotplatform_gateway.connectors.modbus.entities.master import Master
