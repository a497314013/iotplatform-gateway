...
from iotplatform_gateway.connectors.converter import Converter, log
from iotplatform_gateway.gateway.proto.messages_pb2 import ConnectMsg, DisconnectMsg, GatewayAttributesMsg, GatewayAttributesRequestMsg, GatewayClaimMsg, \
