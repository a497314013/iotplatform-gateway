...
from iotplatform_gateway.gateway.constants import DEV_MODE_PARAMETER_NAME, PROVISIONED_CREDENTIALS_FILENAME
            ...
            while not self.client.is_connected() and not self.__stopped:
                if not self.__paused:
                    ...
                    if self.client._client.is_connected():
                        ...
                        self.__logger.info("Connecting to IOTPlatform...")
                    try:
